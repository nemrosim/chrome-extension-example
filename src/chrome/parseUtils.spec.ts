...
describe('Irbis', () => {
    ...
    <a href="/cgi-bin/irbis_ir/cgiirbis_64.exe?Z21ID=&amp;I21DBN=ELIB&amp;P21DBN=ELIB&amp;S21STN=1&amp;S21REF=10&amp;S21FMT=online_book&amp;C21COM=S&amp;S21CNR=20&amp;S21P01=0&amp;S21P02=0&amp;S21P03=FF=&amp;S21STR=${fileName}">ANY TEXT</a>
</p>
`
...
describe('Rgada', () => {
    test('should parse "JPEG" links', () => {
        ...
        document.body.innerHTML = `<div class="es-carousel">
    <ul style="width: 12250px; display: block; margin-left: 0px;">
        ...
        <li><a><img src="../3/23/101.jpg" data-large="2/381_1_47/0102.jpg" data-largeim="1/381_1_47/0102.zif"
                    alt="image102"></a></li>
        <li><a><img
